...
public class RegistrationSteps {
    ...
    public void the_user_enters_mobile_number(String phnumber) {
        driver.findElement(By.id("userNumber")).sendKeys(phnumber);
    }
//    @When("the user selects hobbies {string} and {string}")
//    public void the_user_selects_hobbies(String hob1, String hob2) {
//        driver.findElement(By.xpath("//label[@for='"+hob1+ "']")).click();
//        driver.findElement(By.xpath("//label[@for='"+hob2+ "']")).click();
//    }
